...
namespace EECom\ClubShop\Core\Content\EEComClub\Aggregate\EEComClubMedia;
...
class EEComClubMediaDefinition extends MappingEntityDefinition
{
    public const ENTITY_NAME = 'eecom_club_media';
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            (new FkField('eecom_club_id', 'eecomClubId', EEComClubDefinition::class))->addFlags(new PrimaryKey(), new Required()),
