...
namespace EECom\ClubShop\Core\Content\EEComTeam\Aggregate\EEComTeamMedia;
...
class EEComTeamMediaDefinition extends MappingEntityDefinition
{
    public const ENTITY_NAME = 'eecom_team_media';
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            (new FkField('eecom_team_id', 'eecomTeamId', EEComTeamDefinition::class))->addFlags(new PrimaryKey(), new Required()),
