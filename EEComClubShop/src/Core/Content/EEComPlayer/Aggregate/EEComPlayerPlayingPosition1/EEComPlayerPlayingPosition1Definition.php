...
namespace EECom\ClubShop\Core\Content\EEComPlayer\Aggregate\EEComPlayerPlayingPosition1;
...
class EEComPlayerPlayingPosition1Definition extends MappingEntityDefinition
{
    public const ENTITY_NAME = 'eecom_player_playing_position_1';
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            new ManyToOneAssociationField('playingPosition', 'eecom_playing_position_id', EEComPlayingPositionDefinition::class, 'id')
        ]);
    }
}
