...
namespace EECom\ClubShop\Core\Content\EEComPlayer\Aggregate\EEComPlayerPlayingPosition2;
...
class EEComPlayerPlayingPosition2Definition extends MappingEntityDefinition
{
    public const ENTITY_NAME = 'eecom_player_playing_position_2';
